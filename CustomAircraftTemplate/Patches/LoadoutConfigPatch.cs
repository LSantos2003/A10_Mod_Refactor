    ...
    public static class EquipComaptibilityPatch
    {
        public static bool Prefix(LoadoutConfigurator __instance, HPEquippable equip)
        {
            ...
            if (true) // fuck you c ; work on manners you ape
            {
                ...
                allowedhardpointbyweapon.Add("fa26_aim9x2", "10,1");
                allowedhardpointbyweapon.Add("fa26_aim9x3", "");
                allowedhardpointbyweapon.Add("fa26_cagm-6", "");
                allowedhardpointbyweapon.Add("fa26_cbu97x1", "7,6,5,4");
                allowedhardpointbyweapon.Add("fa26_droptank", "7,4");
                allowedhardpointbyweapon.Add("fa26_droptankXL", "13");
                allowedhardpointbyweapon.Add("fa26_gbu12x1", "7,6,5,4");
                allowedhardpointbyweapon.Add("fa26_gbu12x2", "");
                allowedhardpointbyweapon.Add("fa26_gbu12x3", "7,6,5,4");
                allowedhardpointbyweapon.Add("fa26_gbu38x1", "8,7,6,5,4,3");
                allowedhardpointbyweapon.Add("fa26_gbu38x2", "");
                allowedhardpointbyweapon.Add("fa26_gbu38x3", "7,6,5,4");
                ...
                allowedhardpointbyweapon.Add("fa26_maverickx3", "7,6,5,4");
                allowedhardpointbyweapon.Add("fa26_mk82HDx1", "10,8,7,6,5,4,3,1");
                ...
                allowedhardpointbyweapon.Add("fa26_mk83x1", "");
                ...
                allowedhardpointbyweapon.Add("cbu97x1", "7,6,5,4");
                ...
                allowedhardpointbyweapon.Add("mk82x1", "10,8,7,6,5,4,3");
                ...
                allowedhardpointbyweapon.Add("af_aim9", "10,1");
                ...
                allowedhardpointbyweapon.Add("af_mk82", "10");
                allowedhardpointbyweapon.Add("af_tgp", "9,2,13");
                allowedhardpointbyweapon.Add("h70-x7ld", "8,3");
